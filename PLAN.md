...
- [x] Milestone 0 — workspace, service shells, Compose, CI
- [x] Milestone 1 — PostGIS schema, importer, deterministic fixture
- [x] Milestone 2 — nearby, bounding-box, and detail APIs
- [x] Milestone 3 — text search and autocomplete
- [x] Milestone 4 — transparent ranking and cursor pagination
...
captured from a real run and are never fabricated in source control.
